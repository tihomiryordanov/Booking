...
namespace Booking.Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        {
            IEnumerable<SelectListItem> villaList = _context.Villas
        ...
        public IActionResult Create(VillaNumberVM obj)
        {
            ...
            {
                ModelState.AddModelError("VillaNumberId", "Selected Villa Number does not exist.");
        ...
        public IActionResult DeleteConfirmed(VillaNumberVM obj)
        {
            if (ModelState.IsValid)
            {
                ...
                var villaNumber = _context.VillaNumbers.FirstOrDefault(v => v.Villa_Number == obj.VillaNumber.Villa_Number);
                if (villaNumber == null)
                {
