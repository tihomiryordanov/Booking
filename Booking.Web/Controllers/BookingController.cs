...
namespace Booking.Web.Controllers
{
    ...
    public class BookingController : Controller
    {
        ...
        {
            BookingTable bookingFromDb = _bookingService.GetBookingById(bookingId);
        ...
        public IActionResult GenerateInvoice(int id, string downloadType)
        {
            ...
            //Update Template
            BookingTable bookingFromDb = _bookingService.GetBookingById(id);
        ...
        {
            IEnumerable<BookingTable> objBookings;
            string userId = "";
